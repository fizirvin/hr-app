        ...
        return (
            <div className='worker_container'>
                <table className='worker_table'>
                    <tbody>
                        <tr>
                            <td rowSpan='2' colSpan='1' className='image_field'><img className="image_profile" src={this.props.picture_URL} alt="Logo" height="50" width="50"/></td>
                            ...
                            <td rowSpan='2' colSpan='1' className='update_field'><Link to='/employees/new'><img alt="" height= "26" src={update}/></Link></td>
                        </tr>
                        <tr>
